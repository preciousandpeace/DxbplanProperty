    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li><a>.  >  .</a></li>
                <li><a href="{{route('property.properties')}}"> Properties.</a></li>
                ...
                <div class="sidebar mrb">
                    ...
                    <div class="widget categories">
                        ...
                        <ul>
                            ...
                            <li class="{{request()->property == $layout->name ? 'active nav-link pills ' : ''}}"><a
                                    href="{{route('property.02Tower', ['property' => $layout->name])}}">{{$layout->name}}<span>{{\App\Property::where('layout_id' ,'=', $layout->id )->count()}}</span></a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                        ...
                        <div class="property-box">
                            <div class="property-thumbnail">
                                <a href="properties-details.html" class="property-img">
                                    ...
                                    <a href="google.com"><img src="{{asset('/assets/img/'.$property->image.'.jpg')}}"
                                                              alt="property-7" class="img-fluid"></a>
                                </a>
                            ...
                            <div class="detail">
                                ...
                                <div class="location">
                                    <a href="properties-details.html">
                                        <i class="fa fa-money"></i>Sarting from from <h1>
                                            {{$property->convertPrice()}}</h1>
                                    </a>
                                </div>
