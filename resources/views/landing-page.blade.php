            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                        <div class="carousel-content container">
                            <div class="t-center">
                                <h2 data-animation="animated fadeInDown delay-05s">DxbPlanProperty Makes<br/>Buying Amazing And Simple</h2>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                        <div class="carousel-content container">
                            <div class="t-right">
                                <h2 data-animation="animated fadeInDown delay-05s">Find Your Dream Properties<br/> with DxbPlanProperty </h2>
                                <p data-animation="animated fadeInUp delay-10s">
                                    DxbPlanProperty, number 1 for buying real estate in Dubai.
                                </p>
                                <a data-animation="animated fadeInUp delay-10s" href="{{route('property.properties')}}" class="btn btn-lg btn-round btn-theme">View Our Properties</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption banner-slider-inner d-flex h-100 text-center">
                        <div class="carousel-content container">
                            <div class="t-left">
                                <h2 data-animation="animated fadeInUp delay-05s">Best Place For <br/> Buying Properties in Dubai</h2>
                                <p data-animation="animated fadeInUp delay-10s">
                                    DxbPlanProperty, number 1 for buying real estate in Dubai.
                                </p>
                                <a data-animation="animated fadeInUp delay-10s" href="{{route('property.properties')}}" class="btn btn-lg btn-round btn-theme">View Our Properties</a>
...
<div class="most-popular-places content-area-3">
    <div class="container">
        ...
        <div class="send-btn pt-4 text-center">
            <a href="{{route('property.properties')}}"><button type="submit" id="button" class="btn btn-color btn-md btn-message">View More Properties</button></a>
        </div>
    </div>
</div>
